...
function showcalculation1()
{
    ...
    setTimeout(function()
            {
                ...
                document.getElementById("vibhit3").style.visibility="visible";
                document.getElementById("vibhit4").style.visibility="visible";
            },200);
    document.getElementById("img2").style.animation="shakespg 0.5s infinite";
    ...
    document.getElementById("vibhit3").style.animation="shake 0.5s infinite";
    document.getElementById("vibhit4").style.animation="shake 0.5s infinite";

    setTimeout(function()
            {
                document.getElementById("hammer1").style.animation="";
                document.getElementById("canvas2").style.visibility="hidden";
